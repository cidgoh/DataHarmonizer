...
class DataHarmonizer {
  ...
  async openFile(file) {
    ...
    try {
      ...
      if (file.type === 'application/json') {
        ...
        const { schema, in_language, location } = importJsonFile(jsonData);
        ...
        if (this.schema.id !== schema) {
          ...
          Object.keys(jsonData.Container).forEach((container_class) => {
            ...
            if (list_data != null) {
              ...
              this.context.dhs[range].hot.loadData(list_data);
              this.context.dhs[range].hot.render();
            }
          });
        } else {
   ...
   */
  getFields() {
    console.log("template comparisons", this.context.template, this.sections)
            ...
            .selectize({
              ...
              render: {
                ...
                option: (data, escape) => {
                  ...
                  }" data-i18n='${data.text.trim()}'>${escape(data.text)}</div>`;
                },
              },
