...
class DataHarmonizer {
  ...
  getChangeReport(class_name, changes = {}) {
    let change_message = '';
    let change_report = this.context.crudGetDependentChanges(class_name, changes);
    for (let [dependent_name, dependent] of change_report) {
    ...
    return [change_report, change_message];
  }
