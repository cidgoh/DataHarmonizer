...
import { isValidHeaderRow, rowIsEmpty, wait } from './utils/general';
import {
  changeCase,
  dataArrayToObject,
  dataObjectToArray,
...
class DataHarmonizer {
  ...
  */
  ...
  getFields() {
    ...
    const filteredFields = this.field_filters.length > 0 ? fields.filter(field => this.field_filters.includes(field.name)) : fields;
