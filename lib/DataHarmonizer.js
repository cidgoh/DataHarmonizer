...
class DataHarmonizer {
  ...
  constructor(dhGrid, dhFooter = null, options = {}) {
    this.dhGrid = dhGrid;
    this.dhFooter = dhFooter;
    this.schema = options.schema;
    this.loadingScreenRoot = options.loadingScreenRoot || this.dhGrid;
    this.self = this;
  ...
  createHot() {
    ...
    if (fields.length) {
      ...
      this.hot = new Handsontable(this.dhGrid, this.hot_settings);
