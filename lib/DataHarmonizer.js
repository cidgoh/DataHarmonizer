    ...
    try {
      ...
      if (file.type === 'application/json') {
        ...
        if (this.schema.id !== schema) {
          ...
          let dataObjects = jsonData.Container[this.class_assignment].map(obj => translateObject(obj, 'default', ' '));
          // HACK, remove ASAP
        ...
        if (jsonData.in_language) {
          const languageSelect = $('#select-language-localization');
