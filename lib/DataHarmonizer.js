...
class DataHarmonizer {
  ...
  _persistColWidths() {
    ...
    dh_settings.schema[schemaKey].colWidths[this.template_name] = { ...this._userColWidths };
  ...
  restoreColWidths(schemaKey) {
    ...
    this._userColWidths = {};
    for (const [col, width] of Object.entries(saved)) {
      this._userColWidths[parseInt(col)] = parseInt(width);
    }
