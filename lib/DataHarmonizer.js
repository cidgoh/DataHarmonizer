    ...
    for (let field of fields) {
      ...
      if (field.sources) {
        ...
        if (field.multivalued === true) {
          ...
          //data: 'column1',
          //col.type = 'autocomplete'; // Ensure the cell type is autocomplete
          //source: ['Option A', 'Option B', 'Option C'], // Autocomplete source
          //col.renderer = 'key-value-list'; // Use your custom renderer alias

          /* only for autocomplete?
          col.source = col.source.map(x => x.label);
          if (
