        ...
        for (let dep_row in rows) {
          ...
          switch (class_name) {
            ...
            case 'SlotUsage':
              ...
              ]); // 'equals_expression' ; don't really need rank here either.
              break;
            ...
            case 'PermissableValues':
              ...
              this.copySlots(class_name, record, schema.enums[record.enum_id].permissible_values, ['name','text','description','meaning']); // is_a
              break;
