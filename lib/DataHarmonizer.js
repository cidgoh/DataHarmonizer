...
class DataHarmonizer {
  ...
  enableMultiSelection() {
    ...
    //   if (fields[field].multivalued == true && fields[field].rank !== null) {
    //     // Assuming 'hot' is your Handsontable instance
    //     const colIndex = fields[field].rank; // Replace with the index of the column you want to iterate over
    //     const numRows = this.hot.countRows();
    //     for (let rowIndex; rowIndex < numRows; rowIndex++) {
    //       console.log(this.hot.getCell(rowIndex, colIndex))
    //     }
    //   }
    // }
            ...
            .selectize({
              ...
              render: {
                item: function(data, escape) {
                  ...
                  return `<div data-i18n='${data.text}'>` + escape(label) + `</div>`;
                },
                option: (data, escape) => {
                  const label = i18next.t(data.text);
