  ...
  updateSources(slot) {
    ...
    slot.sources.forEach((source) => {
      ...
      if (!(source in slot.permissible_values)) {
        alert(`Schema Programming Error: Slot range references enumeration ${source} but this was not found in enumeration dictionary, or it has no selections`);
      }
      else
          ...
          */
          ...
          $('#field-description-text .multiselect')
            .selectize({
              ...
              //selectOnTab: false,
              options: meta.source,
              items: dh.getDataAtCell(row, col)?.split(';') || [],
              delimiter:';',
              hideSelected: false,
              ...
              */
              render: {
                ...
                option: (data, escape) => {
                  ...
                  let indentation = 12 + parseInt(data.depth) * 30; // pixels
