 ...
 */
export default class KeyValueListEditor extends Handsontable.editors.HandsontableEditor {
      ...
      Object.assign(this.htOptions, {
        ...
        beforeValueRender(value, { row, instance }) {
          ...
          if (instance) {
            ...
            const translated_value = i18next.t(_id) !== _id ? i18next.t(_id) : label;
...
export const keyValueListRenderer = function(hot, TD, row, col, prop, value, cellProperties) {
