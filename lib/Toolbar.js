...
class Toolbar {
  ...
  // async fetchSchemaAndDependencies(schema_name, template_name) {
  ...
  //   return { schema, exportFormats, languages };
  // }
  
  // initLanguageSelection(languages, template_name) {
  ...
  // initExportFormats(exportFormats, template_name) {
  ...
  //     }
  //   } else {
  //     const templatePath = this.$selectTemplate.val();
  //     const [schemaName, templateName] = templatePath.split('/');
  //     ({ schema, exportFormats, languages } = await this.fetchSchemaAndDependencies(schemaName, templateName));
  
  //     this.initLanguageSelection(languages, templateName);
  //     this.initExportFormats(exportFormats, templateName);
  //   }
  //   this.dh.useSchema(schema, exportFormats, templateName);
  ...
  async loadSelectedTemplate(file = null) {
    console.log("loadSelectedTemplate")
    let template_name;
    let schema;
    let exportFormats;
    let languages;
    ...
    if (file) {
      ...
      console.log(this.$selectTemplate, this.$selectTemplate.val())
      ...
      console.log(template_name, await this.getSchema(schema_name, template_name))
      ...
      console.log(schema, exportFormats, languages);
