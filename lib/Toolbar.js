  ...
  async loadSelectedTemplate(file = null) {
    ...
    const updateGUI = ({
      ...
      translationSelect.on('input', () => {
        const language_update = translationSelect.val() !== 'en' ? translationSelect.val() : 'default';
        ...
        if (supportsLocale) {
          ...
          try {
            this.context.template.updateLocale(language_update);
                      ...
                      ? (() => { 
                        ...
                        const translate_multi = obj
                          ...
                          .map(o => i18next.t(o, { 
                            ...
                            ns: i18next.language === 'default'? 'reverse' : 'translation'
                           }))
