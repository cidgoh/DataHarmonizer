...
class Toolbar {
  ...
  updateGUI(
      ...
      if (supportsLocale) {
        ...
        try { 
          ...
          for (const dh in this.context.dhs) {
            ...
            _dh_data_cache[dh] = translateData(translatableFields(fields), data);
          };
    ...
    if (this.context.template.schema.classes[template_name].see_also) {
      helpSop.attr('href', this.context.template.schema.classes[template_name].see_also).show();
    } else {
      helpSop.hide();
    }
