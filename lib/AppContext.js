...
import { invert, consolidate } from '@/lib/utils/objects';
  ...
  addTranslationResources(template, locales = null) {
    ...
    languageCodes.forEach((sourceLang) => {
      languageCodes.forEach((targetLang) => {
        ...
        i18n.addResources(sourceLang, translationNamespace, removeNumericKeys(sourceTranslation));
        ...
        i18n.addResources(targetLang, reverseNamespace, removeNumericKeys(reverseTranslationMap));
