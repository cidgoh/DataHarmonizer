...
export default class AppContext {
  ...
  refreshTabDisplay() {
    ...
    // Record hierarchy cookie crumbs: shown for "Records by key" (full trail)
    // and for "Records by selected schema" (first crumb only).
    $('#record-hierarchy').toggle(report_type === '' || report_type === 'schema');
