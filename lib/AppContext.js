...
const DH_TERMS = {
  ...
  // Keys that are prose tokens (slot, 'schema slot', Slot_group, …) are resolved
  ...
  default: {
    ...
    Slot_group:         'Table section',
    slot_group:         'section',
    slot_groups:        'sections',
    'Slot name':        'Field ID',
    slots:              'fields',
    'table attribute':  'table attribute',
    'table slot':       'table field',
    UniqueKey:          'Table key',
  },
  ...
  linkml: {
    ...
    'class.slot_usage': 'class.slot_usage',
    Enum:               'Enum',
