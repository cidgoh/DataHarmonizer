...
export default class AppContext {
  ...
  refreshTabDisplay() {
    ...
    // Visibility of "focused table" menu depends on selection of 
    // slot_usage or attribute report.
...
*/
  ...
  useTemplate(dh, template_name) {
    ...
    const raw_attributes = Object.entries(this.template.default.schema.classes)
  ...
  */
  ...
  crudUpdateRecordPath() {
    ...
    while (stack.length >0) {
      ...
      let tooltip_text = `<span class="tooltipytext">${class_label} [ ${tooltip} ]</span>`;
      done[class_name] = `<b>${class_label}</b>&nbsp;<span class="tooltipy">[${key_string}]${tooltip_text}</span> `;
