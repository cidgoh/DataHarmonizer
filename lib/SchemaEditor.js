	  ...
	  $('#fkm-confirm-btn').off('click.fkm').on('click.fkm', () => {
	    ...
	    if (visualRow === null) {
	      if (slot_type === 'slot') {
	        ...
	        // Re-sort so the new schema slot moves to its rank-ordered position within the section.
	        ...
	        const _vRowA = _physA !== null ? hot.toVisualRow(_physA) : null;
	        if (_vRowA !== null && _vRowA !== -1) {
	          hot.selectCell(_vRowA, 0);
	          hot.scrollViewportTo(_vRowA, 0);
	        } else {
	        ...
	        const _vRowB = _physB !== null ? hot.toVisualRow(_physB) : null;
	        if (_vRowB !== null && _vRowB !== -1) {
	          hot.selectCell(_vRowB, 0);
	          hot.scrollViewportTo(_vRowB, 0);
	        } else {
	          hot.selectCell(targetRow, 0);
	          hot.scrollViewportTo(targetRow, 0);
	        }
