...
// NOTE THAT CAPTIONS ARE PROCESSED BY i18N, so go to translations to edit content.
const slides = [
  {
    image: 'images/locale/en/carousel_editCopyPasteDelete.gif', //editCopyPasteDelete,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_changeTemplate.gif', //changeTemplate,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_toggleRequiredCols.gif', //toggleRequiredCols,
    caption: [
      `Fields are colour-coded; required fields (minimal metadata) are yellow, strongly recommended fields are purple, optional fields are white/gray.\n
      You can toggle between all, the required fields, and the required + recommended fields by going to “Settings” and selecting “Show required columns”, etc.`,
    ],
  },
  {
    image: 'images/locale/en/carousel_doubleClickHeaders.gif', //doubleClickHeaders,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_selectingVals.gif', //selectingVals,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_validatingCells.gif', //validatingCells,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_showRows.gif', //showRows,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_showSection.gif', //showSection,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_jumpToColumn.gif', //jumpToColumn,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_fillColumn.gif', //fillColumn,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_exportingFiles.gif', //exportingFiles,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_provenance.gif', //provenance,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_moreInfo.gif', //moreInfo,
    caption: [
  ...
  {
    image: 'images/locale/en/carousel_versionUpdate.gif', //versionUpdate,
    caption: [
