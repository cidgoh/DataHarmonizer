    ...
    const validate = (value) => {
      ...
      for (const value of splitValues) {
        ...
        if (slotType) {
          ...
          if (parsed === undefined) {
            // If any_of validators exist, slotType was derived from any_of[0] rather
            // than a direct range — a parse failure here is not conclusive because
            // another branch (e.g. NullValueMenu) may accept the value.
            // Fall through so anyOfValidators can make the decision.
