    ...
    (acc, [lang, translation]) => ({
      ...Object.assign(acc, {
        [lang]: {
          [namespace]: {
            ...translation,
            'multiselect': '{{ value, multiselectFormatter }}'
          }
        },
      }),
    }),
...
const withMultiSelect = (namespace) => (obj) => {
  Object.entries(obj).reduce(
    (acc, [lang, translation]) => ({
      ...Object.assign(acc, {
        [lang]: {
...
export function initI18n(langChangeCallback = rerender) {
    ...
    .init(
      {
        ...
        fallbackLng: 'en',
        resources: {
          ...withNamespace('translation')(labels),
        }, // initial resources
        interpolation: {
          escapeValue: false,
        }
  ...
  i18next.services.formatter.add('multiselectFormatter', (value, lng, options) => {
    console.log('multiselectFormatter', value, lng, options)
    const formattedSelection = formatMultivaluedValue(value.map(i18next.t)); 
