...
with open(schema_filename, 'r') as input_handle:
...
with open(schema_filename, 'w') as output_handle:
	# DO NOT USE sort_keys=True because this overrides OrderedDict() sort order.
	output_handle.write("var DATA = " + yaml.dumps(DATA, sort_keys = False, indent = 2, separators = (',', ': ')));
