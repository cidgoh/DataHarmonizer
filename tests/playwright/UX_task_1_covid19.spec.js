...
/**
 * Find a row in Schema/Class tab .ht_master by colIdx + text.
 ...
 *
 * Needed for large schemas where HOT's virtual rendering hides rows that are
 * below the current viewport + viewportRowRenderingOffset (30 rows).
 */
